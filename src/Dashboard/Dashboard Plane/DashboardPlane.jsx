...
const DashboardPlane = ({
 ...
 // Check if position changed to trigger animation
 ...
 if (prevPos) {
 const deltaX = (prevPos.col - position.col) * 50; // Approximate pixel width per column
 const deltaY = (prevPos.row - position.row) * 50; // Approximate pixel height per row
