...
function App() {
 ...
 const folderOperationsModal = useModal(); // Added modal hook for FolderOperations
 ...
 folderOperationsModal.close(); // Close FolderOperations modal
 },
 [
 setEditMode,
 setSelectedTemplateIndex,
 ...
 onOpenFolderModal={onOpenFolderOperationsModal} // Pass folder modal opener
 />
 ...
 onOpenSheetsModal={onOpenSheetsModal}
 onOpenSheetFolderModal={onOpenSheetFolderModal}
 onOpenFolderOperationsModal={onOpenFolderOperationsModal} // Correct prop
 />
 </div>
 </div>
 );
